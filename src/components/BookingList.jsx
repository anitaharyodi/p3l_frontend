...
const BookingList = () => {
  const { bookingList, tglCheckin, tglCheckOut, total, adults, kids } = useContext(RoomContext);
              ...
              <ModalContent>
                ...
                <ModalBody>
                  ...
                  <p className="font-medium">
                   Please ensure the above details are correct before proceeding to the booking page.

                    After proceeding to the booking page, we will lock your booking data.
                  </p>
                </ModalBody>
                <ModalFooter>
                  <button

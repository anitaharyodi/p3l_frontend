...
const GroupBooking = () => {
  ...
  const { bookingListGroup } = location.state || { bookingListGroup: null };
  const { id } = useParams();
  ...
  const {
    isOpen: InputIsModalOpen,
    onOpen: openInputModal,
    onOpenChange: onInputModalOpenChange,
  ...
  const handlePembayaran = () => {
    if (selectedFile) {
      ...
      body.append("uang_jaminan", inputDP);
      ...
      axios
        ...
        .then((response) => {
          ...
          navigate(`/home/historyReservation?id=${customer.id}`);
        })
        .catch((error) => {
                  ...
                  <div className="bg-white shadow-md p-6 my-4 rounded-md">
                    ...
                    <div className="flex items-center mt-8">
                      ...
                      <p className="font-semibold">
                        {" "}
                        {formatDate(reservation?.tgl_checkin)}
                      </p>
                    </div>
                    <div className="border-t-2 mt-3 border-gray-100"></div>
                    <div className="flex items-center mt-2">
                      ...
                      <p className="font-semibold">
                        {" "}
                        {formatDate(reservation?.tgl_checkout)}
                      </p>
                    </div>
                    <div className="border-t-2 mt-3 border-gray-100"></div>
                    <div className="flex items-center mt-2">
                ...
                <div className="mb-6">
                  ...
                  <div className="bg-white shadow-md my-4 rounded-md p-6 font-medium">
                    <div className="grid grid-cols-2 gap-4">
                      {special_req_array?.length > 0 ||
                      transaksiFasilitas?.length > 0 ? (
                        <>
                          ...
                          {transaksiFasilitas.map((trxFasilitas) => (
                            <p className="col-span-1">
                              - ({trxFasilitas.jumlah}x){" "}
                              {trxFasilitas.fasilitas_tambahans.nama_fasilitas}
                            </p>
                          ))}
                        </>
                      ) : (
          ...
          <>
            <div id="payment">
              ...
              <div className="bg-white shadow-md my-4 rounded-md pb-4">
                <div className="bg-[#1E2131] p-6 h-[70px] rounded-t-md text-white">
                  <h3 className="h3 text-[20px]">
                    ID Booking #{reservation?.id_booking}
                  </h3>
                </div>
                {bookRoom
                    ...
                    return (
                      <div key={room.id_jenis_kamar}>
                        <div className="pt-6 px-6 flex items-center">
                          ...
                          <div className="ml-4">
                            <p className="font-bold font-tertiary tracking-[1px]">
                              ({roomCounts[room.id_jenis_kamar]}x){" "}
                              {room.jenis_kamars.jenis_kamar}
                            </p>
                            <p className="text-gray-600 text-[12px]">
                              {numberOfNights} nights
                            </p>
                          ...
                          <div className="ml-auto">
                            <p className="font-tertiary tracking-[1px] font-semibold text-[17px] text-[#526166]">
                              {formatCurrency(
                                roomCounts[room.id_jenis_kamar] *
                                  numberOfNights *
                                  room.hargaPerMalam
                              )}
                            </p>
                ...
                <div className="mt-4 mx-6 mb-4">
                  <div className="border-1 p-3 mb-4 rounded-md">
                    ...
                    <div className="flex justify-between mt-4">
                      ...
                      <p className="font-tertiary tracking-[1px] font-semibold text-[20px] text-gray-500">
                        {formatCurrency(reservation?.total_harga * 0.5)}
                      </p>
                    </div>
                  </div>
                  <div className="mb-6">
            ...
            >
              <ModalContent>
                <ModalHeader>
                  <div className="flex flex-col items-center w-full">
                    <p className="text-center mt-1 uppercase text-[#1E2131] font-bold tracking-[1px]">
                      Input the nominal of down payment
                    </p>
                  </div>
                </ModalHeader>
                <ModalBody>
                  <p>Minimum down payment is 50% of the total price</p>
                  <p>
                  ...
                  <Input
                    ...
                    placeholder="Input down payment nominal"
                    value={inputDP}
            ...
            >
              <ModalContent>
                ...
                <ModalBody>
                  <p className="font-semibold">
                    Are you sure the evidence of payment is correct?
                  </p>
                  <p className="font-medium">
